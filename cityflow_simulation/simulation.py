...
def get_raw_light_signal(road_ids):
    ...
    # Raw signal string: each road's id followed by its signal, separated by commas.
...
for step in range(300):
    ...
    # Combined payload that includes both the summary and raw detail.
    traffic_data = {
    ...
    time.sleep(3)  # ⏳ Delay to simulate real-time traffic
